...
const AdminNavbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Add Housing', icon: <FaPlusCircle className="mr-2" />, href: '/admin/add-housing' },
    { name: 'Tenants', icon: <FaUsers className="mr-2" />, href: '/admin/tenants' },
    { name: 'Rentals', icon: <FaFileContract className="mr-2" />, href: '/admin/rentals' },
    { name: 'Complaints', icon: <FaExclamationTriangle className="mr-2" />, href: '/admin/complaints' },
    { name: 'Owner', icon: <FaUserCog className="mr-2" />, href: '/admin/owner' },
  ];
